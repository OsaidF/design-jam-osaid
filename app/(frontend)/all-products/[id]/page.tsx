...
export default async function Page(props: { params: paramsType }) {
  ...
  const { productName, price, gender, reviews, category, image, description } = product[0]

  
  return (
    <div className="flex justify-center min-h-[100vh] w-full sm:min-h-fit md:min-h-fit">
      <div className="flex w-full max-w-[1000px] mt-[48px] h-[900px] sm:flex-col sm:w-[95vw] sm:mt-1 sm:h-auto md:flex-col md:h-auto md:items-center">
        <div className="flex w-1/2 height-auto  sm:min-w-[95vw] md:w-[95vw] md:justify-center">
          <Image
            src={urlFor(image).width(1000).height(1000).url()} width={500} height={500}
            alt="Image"
            className="max-w-[592px] max-h-[592px]  sm:w-[95vw] sm:h-auto md:w-[95vw]"
            priority
          />  
        </div>
        <div className="flex flex-col items-center w-1/2 pt-[30px]  sm:w-[95vw] sm:h-auto sm:pb-[30px] md:w-[95vw] md:pb-[30px]">
            <div className="w-full pl-4 sm:pl-0 md:pl-0">
                <h1 className="text-5xl w-[400px] font-medium sm:w-[95vw] md:w-[95vw] prose-h1:">{productName}</h1>
